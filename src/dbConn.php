...
class DBconn{
    ...
    public function insert($fecha, $company, $qty){
        try {
            ...
            //$stmt = $this->conn->query("INSERT INTO orders (date, company, qty) VALUES('2007-06-05', :company, 2)");
            /*
            ...
            //$stmt-execute();
            /**/
            $query = "INSERT INTO orders (date, company, qty) VALUES(?, ?, ?)";
            $result = $this->conn->prepare($query);
            $result->execute(array($fecha, $company, $qty));
            /**/
            return true;
        } catch (PDOException $e) {
